<%@ Page Title="" Language="C#" MasterPageFile="~/AMasterPage.master" AutoEventWireup="true" CodeFile="Aademp.aspx.cs" Inherits="Aademp" %>
...
<br /><form>
        ...
        <tr>
            <td class="size-205" style="width: 231px">&nbsp;</td><td style="width: 247px">
                <asp:Label ID="Label5" runat="server" Text="Employee exists with same username" 
        ...
        <tr>
            ...
            <td style="width: 247px">
               <asp:Button ID="createbtn1" runat="server" class="stext-101 cl0 size-104a bg1 bor1" 
Text="Create" Height="35px" Width="80px" onclick="createbtn1_Click" 
                    UseSubmitBehavior="False"  /></td>
            <td style="width: 135px">
            <asp:Button ID="resetbtn1" runat="server" class="stext-101 cl0 size-104a bg1 bor1" 
Text="Reset" Height="35px" Width="80px" CausesValidation="False" onclick="resetbtn1_Click" /></td>
        </tr>
        <tr>
            <td class="size-205" style="width: 231px">&nbsp;</td><td style="width: 247px"></td><td></td>
        </tr>
