<%@ Page Title="" Language="C#" MasterPageFile="~/UMasterPage.master" AutoEventWireup="true" CodeFile="Ucategory.aspx.cs" Inherits="Ucategory" %>
...
<section class="bg0 p-t-23 p-b-130">
    ...
    SelectCommand="SELECT * FROM [products] WHERE ([ctgry] = @ctgr)">
        <SelectParameters>
            <asp:SessionParameter Name="ctgr" SessionField="ctry" Type="String" />
        </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
