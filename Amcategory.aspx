<%@ Page Title="" Language="C#" MasterPageFile="~/AMasterPage.master" AutoEventWireup="true" CodeFile="Amcategory.aspx.cs" Inherits="Amcategory" %>
...
<section class="bg0 p-t-23 p-b-130">
    ...
    SelectCommand="SELECT * FROM [products] WHERE ([ctgry] = @ctgr)">
        <SelectParameters>
            <asp:SessionParameter Name="ctgr" SessionField="ctryi" Type="String" />
        </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
