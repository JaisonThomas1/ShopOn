<%@ Page Title="" Language="C#" MasterPageFile="~/UMasterPage.master" AutoEventWireup="true" CodeFile="Uphtl.aspx.cs" Inherits="Uphtl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [products] WHERE ([pname] = @ctgr) ORDER BY [price] DESC">
        <SelectParameters>
            <asp:SessionParameter Name="ctgr" SessionField="ser" Type="String" />
        </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
