<%@ Page Title="" Language="C#" MasterPageFile="~/UMasterPage.master" AutoEventWireup="true" CodeFile="Uplth.aspx.cs" Inherits="Uplth" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [products] WHERE ([pname] = @ctgr) ORDER BY [price]">
        <SelectParameters>
